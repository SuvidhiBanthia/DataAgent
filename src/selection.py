    ...
    for record in data:
        if record.get("source", "").startswith("amazon"):
            ...
            filtered_reviews = [
                ...
                #if all(review.get(key) == value for key, value in filters.items())
                if all(value in str(review.get(key, "")) for key, value in filters.items())
            ]
            if filtered_reviews:
            ...
            filtered_comments = [
                ...
                if all(value in str(comment.get(key, "")) for key, value in filters.items())
            ]
